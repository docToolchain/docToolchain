...
* no support for JDK 8 anymore due to gretty 4.0.3
...
* gradle 6.9.2 => 6.9.3
* gretty 3.0.6 => 4.0.3
* disable spring boot support for gretty
* removed spring boot dependencies from gretty
* drop support for JDK 8


NOTE: Gradle 7.x requires update to asciidoctor plugin
