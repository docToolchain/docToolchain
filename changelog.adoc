...
2021-10-04::
* fix [#616 - Enhance the Confluence Open-API Documentation API to refer to URLs](https://github.com/docToolchain/docToolchain/issues/616) 

=== fixed

2021-09-30::
* fix [#632 - broken images with generateHTML](https://github.com/docToolchain/docToolchain/issues/632) 
