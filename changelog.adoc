...
2021-10-04::
* fix https://github.com/docToolchain/docToolchain/issues/616[#616 - Enhance the Confluence Open-API Documentation API to refer to URLs]

=== fixed

2021-09-30::
* fix https://github.com/docToolchain/docToolchain/issues/632[#632 - broken images with generateHTML]
