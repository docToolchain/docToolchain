        <a href="https://github.com/google/docsy-example/edit/master/content/en/docs/_index.md"
           target="_blank"><i class="fa fa-edit fa-fw"></i> Edit this page</a>
        ...
        <a href="https://github.com/google/docsy-example/issues/new?title=Documentation" target="_blank"><i
                class="fab fa-github fa-fw"></i> Create documentation issue</a>
