...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `actionscript` grammar compiled for Highlight.js 11.8.0 */
...
illegal:/#/}}})();hljs.registerLanguage("actionscript",e)})();/*! `angelscript` grammar compiled for Highlight.js 11.8.0 */
...
}]}}})();hljs.registerLanguage("angelscript",e)})();/*! `apache` grammar compiled for Highlight.js 11.8.0 */
...
})();hljs.registerLanguage("apache",e)})();/*! `applescript` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("arduino",e)})();/*! `asciidoc` grammar compiled for Highlight.js 11.8.0 */
...
}}})();hljs.registerLanguage("asciidoc",e)})();/*! `autohotkey` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("autohotkey",e)})();/*! `autoit` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("autoit",e)})();/*! `bash` grammar compiled for Highlight.js 11.8.0 */
...
})})();hljs.registerLanguage("cmake",e)})();/*! `coffeescript` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("css",e)})();/*! `delphi` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
illegal:"[^\\s\\}\\{]"}}})();hljs.registerLanguage("nginx",e)})();/*! `node-repl` grammar compiled for Highlight.js 11.8.0 */
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `objectivec` grammar compiled for Highlight.js 11.8.0 */
...
relevance:0}]}}})();hljs.registerLanguage("objectivec",e)})();/*! `openscad` grammar compiled for Highlight.js 11.8.0 */
...
begin:"[*!#%]",relevance:0},a]}}})();hljs.registerLanguage("openscad",e)})();/*! `perl` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("powershell",e)})();/*! `profile` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("protobuf",e)})();/*! `python` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("smalltalk",e)})();/*! `sql` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("tcl",e)})();/*! `typescript` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],t=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],s=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],r=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],c=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],i=[].concat(r,t,s)
