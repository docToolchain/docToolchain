...
* Update the version in `dtcw` and `dtcw.ps1`
...
* run https://github.com/docToolchain/docker-image/actions/workflows/standard-build.yml[github action] to build and deplyo the image
