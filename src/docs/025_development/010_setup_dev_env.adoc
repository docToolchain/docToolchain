...
You now have the full repo locally cloned. To save memory, some parts of the repo are zipped. If you have problems, check out the https://github.com/docToolchain/docToolchain/blob/8821e631662d460a4f2c21b3507d92e34f2e4cc5/build.gradle#L79[prepareDist-Task].
