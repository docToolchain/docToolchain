...
The configuration for this task can currently be found winthin `gradle.properties`.
Username/Passwort ist deprecated, so you have to use Username/API-Token instead.
