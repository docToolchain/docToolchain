...
Please upgrade to Java 8 at least.

=== Q: I get an error message saying 'Error occurred during initialization of VM - Could not reserve enough space for 2097152KB object heap'
