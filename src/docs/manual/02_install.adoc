...
rm -d reveal.js
wget https://github.com/hakimel/reveal.js/archive/tags/3.9.1.zip -O reveal.js.zip
unzip reveal.js.zip
mv reveal.js-tags-3.9.1 reveal.js
...
mv mv asciidoctor-reveal.js-2.0.1 asciidoctor-reveal.js
