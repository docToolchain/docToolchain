...
[source, bash]
----
bin/doctoolchain <docDir> generateHTML
bin/doctoolchain <docDir> generatePDF
----

.Windows
[source]
----
bin\doctoolchain.bat <docDir> generateHTML
bin\doctoolchain.bat <docDir> generatePDF
----
