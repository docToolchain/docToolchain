...
+
NOTE: Specifying `.dia` in the name will help you identify PNG files containing embedded XML diagram source.
+
...
.Edit a diagram in Draw.io Offline editor
...
. Find the latest duplicate save of the file. For example, `file.dia.png (3)`
. Delete the previous versions of the file in your working directory. For example, `file.dia.png`, `file.dia.png (1)`, `file.dia.png (2)`.
...
You can repeat this editing workflow each time you need to make changes to your diagrams.
