...
=== History
My name is Ralf Mueller. I'm a developer based in Germany. docToolchain is an open source project that I founded in XXXX.

Before I started the project, I'd never heard of the term 'docs as code'. All I knew what that I was sick of keeping my architecture diagrams up to date by copying them from my UML tool to my word processor. As a lazy developer, I thought to myself "There must be a better way to do this!". So I automated the diagram export, ditched my word processor, and started using a markup renderer. This enabled me to reference the diagrams from within the text and update them before rendering the document.
