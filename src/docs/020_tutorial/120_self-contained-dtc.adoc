...
In order to fetch the docker image from your local docker proxy, please check the source of `dtcw` and update https://github.com/docToolchain/doctoolchain.github.io/blob/eef3309340c3510287cf9e88b56ffd8133f96872/dtcw#L280[the docker image reference].
