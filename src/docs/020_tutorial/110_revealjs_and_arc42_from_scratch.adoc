...
== Reveal.js Presentation and Arc42 from Scratch
...
you are likely using newer version of Java and / or Gradle than supported by the tool. Please make sure you have configured https://sdkman.io[sdkman] to use the correct versions of Java and Gradle (see above).
