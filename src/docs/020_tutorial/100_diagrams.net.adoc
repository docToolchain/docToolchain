...
Diagrams.net (formerly known as Draw.io) is a neat little tool which is able to store the source of oyur diagrams in the meta-data of your `.png` or `.svg` files.
