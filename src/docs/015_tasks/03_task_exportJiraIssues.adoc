:filename: manual/tasks/03_task_exportJiraIssues.adoc
...
[source,groovy]
----
include::{projectDir}/Config.groovy[tags=jiraConfig]
----
...
[source,groovy]
----
include::{projectDir}/scripts/exportJiraIssues.gradle[tags=exportJiraIssues]
----
