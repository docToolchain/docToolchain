...
* `demo1.adoc` will have a menu-code `code1` because it is located in the folder `code1`. 
...
It will not be rendered as part of any menu.
But it will be available in the microsite as "hidden" `_demo4-draft.html`.
