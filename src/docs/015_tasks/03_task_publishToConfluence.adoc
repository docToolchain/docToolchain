:filename: manual/tasks/03_task_publishToConfluence.adoc
...
[source,groovy]
----
include::{projectDir}/Config.groovy[tags=confluenceConfig]
----
...
[source,groovy]
----
include::{projectDir}/scripts/publishToConfluence.gradle[tags=publishToConfluence]
----

.scripts/asciidoc2confluence.groovy
[source,groovy]
----
include::{projectDir}/scripts/asciidoc2confluence.groovy[tags=publishToConfluence]
----
