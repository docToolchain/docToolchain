...
When you use the build in static site generator through xref:03_task_generateSite.adoc[`generateSite`], you sometimes need a real static server locally running to preview the results.
