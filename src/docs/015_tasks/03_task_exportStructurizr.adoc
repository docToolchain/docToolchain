...
You probably want to put the directory configured with `export.outputPath` into your `.gitignore` file.

WARNING: Do not put manually created/changed files into the directory provided with `export.outputPath`.
