:filename: manual/tasks/03_task_exportVisio.adoc
...
[source,groovy]
----
include::{projectDir}/scripts/exportVisio.gradle[tags=exportVisio]
----

.scripts/VisioPageToPngConverter.ps1
[source]
----
include::{projectDir}/scripts/VisioPageToPngConverter.ps1[]
----
