:filename: manual/tasks/03_task_exportOpenApi.adoc
...
[source,groovy]
----
include::{projectDir}/Config.groovy[tags=openApiConfig]
----
...
[source,groovy]
----
include::{projectDir}/scripts/exportOpenApi.gradle[tags=exportOpenApi]
----
