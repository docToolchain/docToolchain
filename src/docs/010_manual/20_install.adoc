...
If you see an older version of docToolchain (e.g., 3.4.1) when you expect the latest version (3.4.2), check if you have the `DTC_VERSION` environment variable set:
...
----
WARNING: DTC_VERSION is set to '3.4.1' via environment variable.
         The default version is '3.4.2'.
         To use the latest version, unset DTC_VERSION: unset DTC_VERSION
----

Follow the instructions to unset the environment variable:
...
[source, powershell]
----
Remove-Item Env:DTC_VERSION
----

After unsetting the variable, `./dtcw --version` should show the latest version.
