...
An easy way to test you configuration is to run `xeyes` in WSL.
...
=== Q: I get an error that gradle dependencies cannot be downloaded because the internet access is resticted by a proxy.
