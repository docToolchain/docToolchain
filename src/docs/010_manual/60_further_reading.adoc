...
Explore resources and technologies to help you with your docToolchain.
...
* *Markdown* +
you can write your docs in Markdown since we use jBake as Static-Site-Generator.
** The Markdown parser and flavor used by jBake is https://github.com/vsch/flexmark-java[flexmark-java].
** https://github.com/bodiam/markdown-to-asciidoc[markdown-to-asciidoc] library is used if you prefer to use xref:../015_tasks/03_task_exportMarkdown.adoc[`exportMarkdown`]-Task. The IntelliJ-Plugin also uses this library.

=== Templates

* *arc42* +
is perfect for documenting your sofwtare solution architecture.
...
* *docs-as-code* +
Treat your docs as if they were code by using this approach. 
