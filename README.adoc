...
image::https://travis-ci.org/docToolchain/docToolchain.svg?branch=travis["Build Status", link="https://travis-ci.org/docToolchain/docToolchain"]
...
image::/docToolchain/images/ea/Manual/Overview2.png[]
