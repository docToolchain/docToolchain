...
image::https://hacktoberfest.digitalocean.com/assets/logo-hf19-full-10f3c000cea930c76acc1dedc516ea7118b95353220869a3051848e45ff1d656.svg[float=left,width=200]
...
Feel free to choose these or any other ticket to participate, or even create pull requests without a prior ticket).*
