...
// IMPORTANT: Database connections via 'connection' parameter are currently NOT SUPPORTED due to VBScript API limitations.
// Use file-based EA projects (.eap, .eapx, .qea, .qeax) instead by placing them in the searchPath directory.
...
exportEA.with {
// IMPORTANT: Database connection strings are NOT SUPPORTED. Use file-based EA projects instead.
// Leave this commented out and place your .eap/.eapx/.qea/.qeax files in the searchPath directory.
...
// exportPath = "src/docs/"
// OPTIONAL: relative path to base 'docDir', in which Enterprise Architect project files (.eap, .eapx, .qea, .qeax) are searched
// searchPath = "src/docs/"
