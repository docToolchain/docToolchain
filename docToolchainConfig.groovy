...
microsite.with {
    ...
    menu = [manual: 'Manual', tasks: 'Tasks', tutorial: 'Tutorial', development: 'Developer', news: 'News', ADRs: '-', ea: '-', ppt: '-', blog: '-']
    ...
    footerText = '<small class="text-white">built with <a href="http://doctoolchain.org">docToolchain</a> and <a href="https://jbake.org">jBake</a> <br /> theme: <a href="https://www.docsy.dev/">docsy</a></small>'
