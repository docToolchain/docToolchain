...
microsite.with {
    ...
    menu = [about: 'About', manual: 'User Docs', tasks: 'Tasks', tutorial: 'Tutorial', development: 'For Devs', news: 'News', ADRs: '-', ea: '-', excel: '-', ppt: '-', blog: '-',
            big_topic_business: 'Demo Topic: Business Docu',
            big_topic_explanations: 'Demo Topic: Explainers',
            big_topic_how_to: 'Demo Topic: How-To',
            big_topic_technical: 'Demo Topic: Technical Docu',
            big_topic_tutorials: 'Demo Topic: Tutorials'
    ]
